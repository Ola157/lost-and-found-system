...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        LostFoundItem item1 = LostFoundItem.builder()
                ...
                .reporterPhoneNo("+1-555-123-4567")
                .createdBy("warwar")
                .modifiedBy("warwar")
        ...
        LostFoundItem item2 = LostFoundItem.builder()
                ...
                .reporterPhoneNo("+1-555-234-5678")
                .createdBy("linhtet")
                .modifiedBy("linhtet")
        ...
        LostFoundItem item3 = LostFoundItem.builder()
                ...
                .reporterPhoneNo("+1-555-345-6789")
                .createdBy("shine")
                .modifiedBy("shine")
        ...
        LostFoundItem item4 = LostFoundItem.builder()
                ...
                .reporterPhoneNo("+1-555-456-7890")
                .createdBy("eaintchit")
        ...
        LostFoundItem item5 = LostFoundItem.builder()
                ...
                .reporterPhoneNo("+1-555-567-8901")
                .createdBy("khinpyone")
        ...
        LostFoundItem item6 = LostFoundItem.builder()
                ...
                .reporterPhoneNo("+1-555-678-9012")
                .createdBy("yeaung")
                .modifiedBy("yeaung")
                .category(Category.FOOTWEAR)
                .description("Lorem ipsum dolor sit amet, consectetur adipiscing elit, " +
        ...
        User admin = userRepository.save(
                User.builder()
                        ...
                        .address(Address.builder().city("Toronto").state(State.ONTARIO).street("Main Street").build())
                        .build());
        ...
        User user1 = User.builder()
                ...
                .address(Address.builder().city("Vancouver").state(State.BRITISH_COLUMBIA).street("Oak Street").build())
        ...
        User user2 = User.builder()
                ...
                .address(Address.builder().city("Montreal").state(State.QUEBEC).street("Rue Sainte-Catherine").build())
        ...
        User user3 = User.builder()
                ...
                .address(Address.builder().city("Calgary").state(State.ALBERTA).street("Stephen Avenue").build())
        ...
        User user4 = User.builder()
                ...
                .address(Address.builder().city("Halifax").state(State.NOVA_SCOTIA).street("Spring Garden Road").build())
        ...
        User user5 = User.builder()
                ...
                .address(Address.builder().city("Winnipeg").state(State.MANITOBA).street("Portage Avenue").build())
        ...
        User user6 = User.builder()
                ...
                .address(Address.builder().city("Edmonton").state(State.ALBERTA).street("Whyte Avenue").build())
